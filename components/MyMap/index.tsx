...
const {actualPos,setActualPos } = useContext(RutappContext) as ActualPosType;
...
const {boolLocation} = useContext(RutappContext) as BoolLocationType;

const {mapCenterPos, setMapCenterPos} = useContext(RutappContext) as MapCenterPosType;

const defaultZoom = ownPosition  ? 18 : 7;
 ...
 const markers: MapMarker[] = [{
  ...
  return (
    ...
    <ExpoLeaflet
              mapLayers={[mapLayer]}
              mapMarkers={
                accionUsuario === "crear" ? [...ubicacionSeleccionada, ...dataMarkers] : ownPosition ?
                ...
                : accionUsuario === 'repartiendo' && repartosArr.length > 0 ?
                  ...
                  mapCenterPosition={boolLocation == true || repartoBool == true ? mapCenterPos : mapCenterPos}
                  maxZoom={18}
