...
const EditarBtn = () => {
  ...
  return (
    ...
    <Text style={{backgroundColor: "#FFFCF0",paddingVertical: 2 ,width: "100%",fontWeight: "bold",textTransform: "uppercase",fontSize: 6, color: "black",textAlign: "center" }}>lista</Text>
