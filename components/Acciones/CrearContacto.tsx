...
const telefono = data.area && data.telefono ? data.area +""+ data.telefono :null;
  ...
  return (
    <ScrollView style={{width: "100%", paddingHorizontal: 20,flex:1, paddingVertical: 10, backgroundColor: "white", gap: 10}}>
      ...
      />
        ...
        <Button mode='elevated' style={{borderColor: "black", borderWidth: 1,marginBottom: 10, backgroundColor: "#FFFCF0"}} onPress={crear}>Crear contacto</Button>
